var executor = 
{
  ...
  execute: function(text)
  {
    ...
    if (teacher.specialHandling(command))
    {
      return;
    }
...
executor.specials = [/clear(\(\);?)?/, /show collections;?/, /help/, /reset/, /restart/, /lesson(\d+);?/]; 
executor.callbacks = [executor.clear, db.getCollectionNames(), help, reset, restart, lesson];